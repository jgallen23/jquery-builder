...
}).complete(c&&function(a,b){g.each(c,f||[a.responseText,b,a])}),this},"function"==typeof define&&define.amd&&define("jquery",[],function(){return n});var Mc=a.jQuery,Nc=a.$;return n.noConflict=function(b){return a.$===n&&(a.$=Nc),b&&a.jQuery===n&&(a.jQuery=Mc),n},typeof b===X&&(a.jQuery=a.$=n),n});
